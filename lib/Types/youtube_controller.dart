...
class YoutubeControllerWrapper implements BaseVideoController {
  final YoutubePlayerController controller;

  YoutubeControllerWrapper(this.controller);
  ...
  @override
  Duration get duration => controller.metadata.duration;
